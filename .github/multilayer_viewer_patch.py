...
Path("viewer/src/main.ts").write_text(r'''import {
  COORDINATE_SYSTEM,
  Deck,
  type PickingInfo,
...
if needle not in text:
    raise SystemExit("legend swatch CSS anchor not found")
style.write_text(text.replace(needle, insert))
...
anchor = '''A representative figure is:
